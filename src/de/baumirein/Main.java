...
import de.baumirein.commands.cmd_back;
import de.baumirein.commands.cmd_force;
...
import de.baumirein.listener.onTimber;
...
public class Main extends JavaPlugin implements Listener{
	...
	public void onEnable() {
		...
		getCommand("force").setExecutor(new cmd_force());
		...
		Bukkit.getPluginManager().registerEvents(new onTimber(), this);
		onTimber.initTimberHashSet();
